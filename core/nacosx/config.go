...
func (c *Config) Register(server ServerInstance) (err error) {
	var client naming_client.INamingClient
	if client = This().NamingClient; client == nil {
		if client, err = c.NamingClient(c.ClientParam()); err != nil {
			return
		}
	}
...
func (c *Config) Deregister(server ServerInstance) (err error) {
	var client naming_client.INamingClient
	if client = This().NamingClient; client == nil {
		if client, err = c.NamingClient(c.ClientParam()); err != nil {
			return
...
func (c *Config) AllInstances(name string) (instances []*ServerInstance, err error) {
...
func (c *Config) GetInstance(name string) (instance *ServerInstance, err error) {
	var servers *model.Instance
